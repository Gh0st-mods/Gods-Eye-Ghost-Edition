...
test('vessel type CSS and card accents stay paired', () => {
  ...
  assert.equal(vesselTypeCss('35'), '#ff2a2a');
  assert.equal(vesselTypeCss('MILITARY'), '#ff2a2a');
  assert.equal(vesselTypeCss('Naval Frigate'), '#ff2a2a');
  assert.equal(accentForVesselType('35'), '255, 42, 42');
