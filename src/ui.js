...
/**
 * Central UI orchestrator for Gods Eye Ghost Edition.
 *
 * Responsibilities:
...
export class StyleManager {
  ...
  /** Resolves after local/share layer-state restore has finished (or been skipped). */
  get layerStateRestorePromise() {
